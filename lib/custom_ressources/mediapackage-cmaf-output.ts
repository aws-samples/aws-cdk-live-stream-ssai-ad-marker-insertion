...
export class CmafOutputValue extends Construct {
  ...
  constructor(scope: Construct, id: string, props: IConfigProps) {
    ...
    const cmafLambdaPolicy = new iam.PolicyStatement({
      actions: ['mediapackage:DescribeChannel', 'mediapackage:ListChannels', 'mediapackage:UpdateChannel', 'mediapackage:ListOriginEndpoints', 'mediapackage:CreateOriginEndpoint', 'mediapackage:UpdateOriginEndpoint', 'ssm:PutParameter'],
      resources: ['*'],
    });
